...
class TeamAdmin(admin.ModelAdmin):
    list_display = ("code", "name", "country_code", "api_football_team_id", "football_data_team_id", "get_flag_preview")
    search_fields = ("code", "name", "api_football_team_id", "football_data_team_id")
    ordering = ["name"]
    fields = ("code", "name", "country_code", "api_football_team_id", "football_data_team_id")
